<%@ Page Title="" Language="C#" MasterPageFile="~/sProfile.master" AutoEventWireup="true" CodeFile="RegistrationC.aspx.cs" Inherits="RegistrationF" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width:100%; height:500px">
        <tr style="text-align:center; vertical-align:middle; background-color:#f7f9fb">
            <td ><br />
                <asp:Image runat="server" ID="imgClient" ImageUrl="~/img/client.png" Width="100px" Height="100px" style="border-radius:50%!important; box-shadow:0 4px 8px 0px #d5d5d5"/><br /><br />
                <asp:Label runat="server" ID="lblRegisC" Font-Size="24px" Font-Bold="true" style="margin-right:260px;">고객 회원가입</asp:Label><br /><br />
                ...
                <asp:TextBox runat="server" ID="txtName" Width="400px" Height="25px" style="margin-top:5px; text-align:left" ></asp:TextBox><br /><br />
