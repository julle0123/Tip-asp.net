<%@ Page Title="" Language="C#" MasterPageFile="~/sProfile.master" AutoEventWireup="true" CodeFile="Freelist.aspx.cs" Inherits="Freelist" %>
    ...
    <table style="width:100%">
        <tr>
            <td style="text-align:left; vertical-align:top" colspan="2">
                <asp:Label runat="server" ID="lblTitle" BackColor="#F7D358" Font-Size="24px" Text="프리랜서 프로젝트" Width="100%" Height="40px" style="font-family:'맑은 고딕'; font-weight: 700; text-align:center"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="text-align:left; vertical-align:top" colspan="2">
                <asp:GridView runat="server" ID="grvBoard" AllowPaging="true" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333"
                    ...
                    <RowStyle BackColor="#F7D358" ForeColor="#333333" />
                    <FooterStyle BackColor="#5D7B9D" Font-Bold="true" ForeColor="White" />
                    <PagerStyle BackColor="#FE9A2E" ForeColor="White" HorizontalAlign="Center" />
        ...
        <tr>
            <td style="width:80%; text-align:right; vertical-align:middle; background:#F5DA81">
                <asp:Label style="background:#ffffff" runat="server" ID="lblMessage" ForeColor="Red" Width="300px"></asp:Label>
            </td>
            <td style="width:20%; text-align:right; vertical-align:middle; background:#F5DA81">
                <asp:Button  runat="server" ID="ibtnWrite" Width="130px" Height="40px" Text="작성" OnClick="ibtnWrite_Click" Visible="false" CssClass="btn btn-warning"/>
            </td>
        </tr>
        <tr>
            <td style="width:100%; height:10px; background-color:#DF7401" colspan="8">
