...
public partial class Noticelist : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            if ((new MemberDao()).GetUgradeOfGradeid(Session["email"].ToString()) >= (new MemberDao().GetUgradeOfGradename("관리자")))
    ...
    {
        grvBoard.DataSource = (new NoticeDao()).GetBoardList();
        grvBoard.DataBind();
    }
    ...
    {
        Response.Redirect("Noticewrite.aspx?md=0");
    }
