<%@ Page Title="" Language="C#" MasterPageFile="~/sProfile.master" AutoEventWireup="true" CodeFile="Clientwrite.aspx.cs" Inherits="ClientWrite" %>
    ...
    <table style="width:100%; background-color:#CCCCFF">
        <tr>
            <td colspan="3" style="text-align:center; vertical-align:middle; ">
                <asp:Label ID="Label1" runat="server" BackColor="#CCCCFF" Text="고객 프로젝트" Width="100%" style="font-family: '맑은 고딕'; font-size: 24px; font-weight: 700; background:#86B404"></asp:Label>
                </td>
            </tr>
        <tr>
            <td style="width:5%; height:51px; text-align:center;  font-family:'맑은 고딕'; font-size:16px; font-weight:700; background-color:#E6F8E0; border:3px solid black;">
                <asp:Label ID="Label2" runat="server" Text="작성자" style="font-family:'맑은 고딕'; font-size:20px" Height="35px"></asp:Label>
                </td>
            
            <td style="width:20%; height:51px; text-align:center; font-family:'맑은 고딕'; font-size:16px; font-weight:700; background-color:#ECF8E0; border:3px solid black;" colspan="3">
        ...
        <tr>
            <td style="width:5%; height:51px; text-align:center;  font-family:'맑은 고딕'; font-size:16px; font-weight:700; background-color:#E6F8E0; border:3px solid black"></td>
            <td style="width:5%; height:51px; text-align:center;  font-family:'맑은 고딕'; font-size:16px; font-weight:700; background-color:#E6F8E0; border:3px solid black">
                <asp:Button ID="btnWirte" runat="server" Width="100px" Height="30px" OnClick="btnWirte_Click" Text="작성" style="margin-left:5px; margin-right:5px" CssClass="btn btn-success"/>
                <asp:Button ID="btnList" runat="server" CausesValidation="false" Width="100px" Height="30px" OnClick="btnList_Click" Text="목록" style="margin-left: 5px; margin-right: 5px" CssClass="btn btn-success"/>
                </td>
            </tr>
        <tr>
            <td style="width:5%; height:51px; text-align:center;  font-family:'맑은 고딕'; font-size:16px; font-weight:700; background-color:#E6F8E0; border:3px solid black"></td>
